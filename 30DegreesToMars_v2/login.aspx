...
<body>
  ...
  <div class="header-container">
      <div class="logo">
          ...
          <asp:Label ID="Label1" runat="server" CssClass="item1" Text="30° TO MARS" Style="font-size: 100px; font-family: 'Arial Rounded MT';"></asp:Label>
      </div>
      <nav class="navbar">
          <ul>
              <li><a href="#">Home</a></li>
  ...
  <div class="main-container">
      ...
      <div class="th">
          <img src="img/StockCake-Mars Rover Exploration_1713601338.jpg" style="width: 450px; height: 492px" alt="Image">
      </div>
  </div>
